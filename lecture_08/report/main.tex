...
\newcommand{\thesistitle}{Parallelizing the Conjugate Gradient Method with CUDA} % Your thesis title, this is used in the title and abstract
...
\newcommand{\typeofthesis}{MATH-454 Assignment 2} % dissertation, Final Year Project, report, etc.
