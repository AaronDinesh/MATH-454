...
\newcommand{\thesistitle}{Parallelizing SWE Simulations} % Your thesis title, this is used in the title and abstract
...
\newcommand{\typeofthesis}{MATH-454 Final Project} % dissertation, Final Year Project, report, etc.
